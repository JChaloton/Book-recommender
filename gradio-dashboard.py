...
# Free local embeddings + persistent Chroma directory
persist_dir = "chroma_books"
...
if os.path.isdir(persist_dir) and os.listdir(persist_dir):
    ...
    db_books = Chroma.from_documents(documents, embeddings, persist_directory=persist_dir)
